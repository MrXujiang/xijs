...
function renderHtml() {
  ...
  div.innerHTML = "this id domId<h1>Hello World</h1><div id='oneId' class='oneClass twoClass'>this id div one</div><div id='twoId' class='twoClass'>this id div two</div>";
...
describe('浏览器相关测试', () => {
  ...
  test("获取元素的文本内容:", () => {
    ...
    expect(getDomText("#domId")).toBe('this id domIdHello Worldthis id div onethis id div two');
